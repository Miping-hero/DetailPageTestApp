package com.example.littletestapp.javaBean;
...
//                        load(imageTitleBeanList.get(count - 1).getImageId()).into(ivImage);
                        load("https://pic.bonwebuy.com"+imageTitleBeanList.get(count - 1).getImageUrl())
                        .into(ivImage);
...
//                        load(imageTitleBeanList.get(0).getImageId()).into(ivImage);
                        load("https://pic.bonwebuy.com"+imageTitleBeanList.get(0).getImageUrl()).into(ivImage);
                tvTitle.setText(imageTitleBeanList.get(0).getTitle());
            } else {
                Glide.with(context).
                        load("https://pic.bonwebuy.com"+imageTitleBeanList.get(i - 1).getImageUrl()).into(ivImage);
